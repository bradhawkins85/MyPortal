...
MyPortal records email open and click events locally for tracked messages.

**Privacy Protection Measures:**
- ✅ Tracking data stays within the MyPortal database
- ✅ No third-party analytics script is injected into portal pages
- ✅ No authenticated user pageviews are exported to external analytics services
- ✅ Tracking only applies to explicit email-tracking links and pixels

**Compliance Notes:**
- Review your privacy policy before enabling email open tracking
