...
| Licences (`/api/licenses`) | create/update/delete and direct staff assignment changes | `license.create/update/delete`, `license.staff.assign/remove` | API licence lifecycle and staff links covered; UI ordering and SKU mapping routes remain in gap register |
