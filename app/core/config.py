...
class Settings(BaseSettings):
    ...
    feature_packs: str = Field(
        default="tickets,service_status,notifications,knowledge_base,chat,assets,automations,reports,backups,issue_tracker,shop,compliance,continuity",
        ...
        description=(
            ...
            "Defaults to 'tickets,service_status,notifications,knowledge_base,chat,assets,automations,reports,backups,issue_tracker,shop,compliance,continuity' "
            "because the ticket, service-status, notifications, knowledge-base, "
            "chat, assets, automations, reports, backups, issue-tracker, shop, compliance, and continuity routes live in those packs; set to an empty string "
