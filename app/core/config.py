...
class Settings(BaseSettings):
    ...
    feature_packs: str = Field(
        default="tickets,service_status,notifications,knowledge_base,chat,assets,automations,reports,backups,issue_tracker,webhooks,shop,quotes,compliance,continuity,help,subscriptions,companies,api_keys",
        ...
        description=(
            ...
            "Defaults to 'tickets,service_status,notifications,knowledge_base,chat,assets,automations,reports,backups,issue_tracker,webhooks,shop,quotes,compliance,continuity,help,subscriptions,companies,api_keys' "
            "because the ticket, service-status, notifications, knowledge-base, "
            "chat, assets, automations, reports, backups, issue-tracker, webhooks, shop, quotes, compliance, continuity, help, subscriptions, companies, and API keys routes live in those packs; set to an empty string "
