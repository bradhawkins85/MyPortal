...
class Settings(BaseSettings):
    ...
    feature_packs: str = Field(
        ...
        description=(
            ...
            "chat, assets, automations, reports, reporting, backups, issue-tracker, webhooks, shop, quotes, invoices, compliance, continuity, help, subscriptions, companies, API keys, call recordings, cart, orders, staff, message templates, Plausible, SMTP, Password Pusher, Solidtime, Trello, Huntress, Hudu, M365 Admin, Reprocess AI, Xero, TacticalRMM, Syncro, and Ollama integrations all live in those packs; set to an empty string "
