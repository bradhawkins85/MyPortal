...
class Settings(BaseSettings):
    ...
    feature_packs: str = Field(
        default="tickets,service_status,notifications,knowledge_base,chat,assets,automations,reports,backups,issue_tracker,shop,compliance,continuity,help",
        ...
        description=(
            ...
            "Defaults to 'tickets,service_status,notifications,knowledge_base,chat,assets,automations,reports,backups,issue_tracker,shop,compliance,continuity,help' "
            "because the ticket, service-status, notifications, knowledge-base, "
            "chat, assets, automations, reports, backups, issue-tracker, shop, compliance, continuity, and help routes live in those packs; set to an empty string "
