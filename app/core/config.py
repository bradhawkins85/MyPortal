...
class Settings(BaseSettings):
    ...
    feature_packs: str = Field(
        default="tickets,service_status,notifications,knowledge_base,chat,automations,reports,backups",
        ...
        description=(
            ...
            "Defaults to 'tickets,service_status,notifications,knowledge_base,chat,automations,reports,backups' "
            "because the ticket, service-status, notifications, knowledge-base, "
            "chat, automations, reports, and backups routes live in those packs; set to an empty string "
