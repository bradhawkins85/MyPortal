...
class Settings(BaseSettings):
    ...
    feature_packs: str = Field(
        default="tickets,service_status,notifications,knowledge_base,chat,assets,automations,reports,backups,issue_tracker,webhooks,shop,quotes,invoices,compliance,continuity,help,subscriptions,companies,api_keys,call_recordings,cart",
        ...
        description=(
            ...
            "Defaults to 'tickets,service_status,notifications,knowledge_base,chat,assets,automations,reports,backups,issue_tracker,webhooks,shop,quotes,invoices,compliance,continuity,help,subscriptions,companies,api_keys,call_recordings,cart' "
            "because the ticket, service-status, notifications, knowledge-base, "
            "chat, assets, automations, reports, backups, issue-tracker, webhooks, shop, quotes, invoices, compliance, continuity, help, subscriptions, companies, API keys, call recordings, and cart routes live in those packs; set to an empty string "
